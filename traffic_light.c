...
void portA_init(void);	  				//button inputs - north road, west road, pedestrian crossing
...
int main(void)
{
	...
	while(1)
	{
		...
		input = (GPIOA->DATA >> 2);																				//taking input from buttons - PD2, PD1, PD0
...
void portA_init(void)
{
	...
	GPIOA->DIR |= 0x00;			//input pins - PA4, PA3, PA2 = button inputs
}
